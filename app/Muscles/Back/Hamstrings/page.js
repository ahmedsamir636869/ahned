...
function Hamstrings() {
  ...
  <div className="bg-white p-4 sm:p-6">
    ...
    <ol className='mt-2 text-sm text-gray-500 pl-2'>
      ...
      <br></br>
      <li>Push your hips back until you feel a stretch in your hamstrings. This means you're nearing the end of your Range of Motion with out rounding your spine.</li>
      <br></br>
      <li>When you feel the stretch push your hips forward until you'e in a standing position.</li>
    </ol>
  </div>
      </article></div>
